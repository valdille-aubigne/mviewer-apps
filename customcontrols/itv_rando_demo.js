mviewer.customControls.itv_rando_demo = (function() {
    /*
     * Private
     */
    var _idlayer = 'itv_rando_demo';
    ...
    var _showResult = function (data) {
        ...
        mviewer.customLayers.itv_rando_demo.layer.getSource().addFeature(feature);
    };
    ...
    return {
		...
		{mviewer.customControls.itv_rando_demo.send_comment(text.value,_xy[0],_xy[1],date_observation.value,mail.value,newFile, nom.value, date_saisie);}
		else
		...
		{
		var xhr = mviewer.customControls.itv_rando_demo.getXMLHttpRequest();
		...
		xhr.open("POST", "/mviewer/apps/rando_interventions_demo/savecomment.php", true);
		...
		var xhr = mviewer.customControls.itv_rando_demo.getXMLHttpRequest();
		xhr.open("POST", "/mviewer/apps/rando_interventions_demo/saveimage.php", true);
		xhr.send(formData);
		...
		mviewer.customControls.itv_rando_demo.destroy();
        ...
        destroy: function () {
            ...
            mviewer.customLayers.itv_rando_demo.layer.getSource().clear();
        },
